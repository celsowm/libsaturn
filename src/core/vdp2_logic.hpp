#ifndef SATURN_CORE_VDP2_LOGIC_HPP
#define SATURN_CORE_VDP2_LOGIC_HPP
...
/* ------------------------------------------------------------------ */
/* Rotation parameter table word offsets (16-bit word indices from     */
/* table base). Matches ST-013-R3-061694 byte layout; divide each    */
/* byte offset by 2.                                                  */
/*                                                                    */
...
/*  Word 14-25: Rotation matrix A-F          (bytes 0x1C-0x2F)        */
/*  Word 26-29: Viewpoint Px, Py, Pz (+pad)  (bytes 0x34-0x3B)        */
/*  Word 30-33: Center Cx, Cy, Cz (+pad)     (bytes 0x38-0x3F)        */
...
constexpr uint32_t kRbg0ScrollZWordOffset      = 4u;
constexpr uint32_t kRbg0ScrollZFracWordOffset  = 5u;
...
/* ------------------------------------------------------------------ */
/* Validation helpers — testable on host with native g++               */
/* ------------------------------------------------------------------ */
...
#endif /* SATURN_CORE_VDP2_LOGIC_HPP */
