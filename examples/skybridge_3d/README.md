...
- VDP1 draws the solid platforms, the player cube, pickups, checkpoints and finish arch as RGB polygons. Basic per-object depth sorting is used because VDP1 has **no depth buffer**. The contact shadow is a checkerboard-mesh polygon, not true alpha. Font glyphs use palette bank 2 and are drawn after the world.
